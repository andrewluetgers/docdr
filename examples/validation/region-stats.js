...
var save = util.saver("results/region-stats/"),
	step = save.step,
	color = util.color;

var img = new dv.Image('png', fs.readFileSync('assets/test1.png'));

var scaled = 		step('scale', 				()=> util.scale(img));
var scaled2 =		new dv.Image(scaled);

// content-region ------------------------------------------------------------------
var eroded = 		step('region-erode', 		()=> scaled.toGray().erode(15, 15));
var openMask = 		step('region-open', 		()=> eroded.dilate(15, 15));
eroded = 			step('region-erode2', 		()=> scaled.toGray().erode(15, 15));
openMask = 			step('region-open2', 		()=> eroded.dilate(15, 15));
