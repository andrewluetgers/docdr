...
function writeImage(basename, image) {
...
describe('Image', function() {
    ...
    it('should #unsharp()', function() {
        writeImage('gray-unsharp.png', this.gray.unsharp(6, 2.5));
    });
    ...
    it('should #nickAdaptiveThreshold()', function() {
        var threshold = this.gray.nickAdaptiveThreshold(16, 16, -0.2);
        writeImage('gray-threshold-nick-image.png', threshold);
    });

    it('should #niblackAdaptiveThreshold()', function() {
        var threshold = this.gray.niblackAdaptiveThreshold(16, 16, -0.2);
        writeImage('gray-threshold-niblack-image.png', threshold);
    });

    it('should #sauvolaAdaptiveThreshold()', function() {
        var threshold = this.gray.sauvolaAdaptiveThreshold(16, 16, -0.2);
        writeImage('gray-threshold-sauvola-image.png', threshold);
    });
